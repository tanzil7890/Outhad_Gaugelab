...
from gaugelab.data.gauge_types import ScorerDataGaugeType
from gaugelab.scorers import BaseScorer
from typing import List


class ScorerData(ScorerDataGaugeType):
    """
    ScorerData holds the information related to a single, completed Scorer evaluation run.

    For example, if running the Gauge Faithfulness scorer on an example, the ScorerData
