...
datamodel-codegen --input gaugelab/data/openapi_new.json --output gaugelab/data/judgment_types.py --use-annotated

# Post-process the generated file to fix mutable defaults
uv run gaugelab/data/scripts/fix_default_factory.py gaugelab/data/judgment_types.py
